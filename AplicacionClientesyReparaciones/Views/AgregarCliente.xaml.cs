...
namespace AplicacionClientesyReparaciones.Views
{
    public partial class AgregarCliente : UserControl
    {
        ...
        {
            InitializeComponent();
            Loaded += AgregarCliente_Loaded;
        }

        private void AgregarCliente_Loaded(object sender, RoutedEventArgs e)
        {
            Dispatcher.BeginInvoke(() => NombreTextBox.Focus(), DispatcherPriority.Input);
        }
        ...
        private async void Guardar_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show(
                    "El móvil 1 debe contener solo números.",
                    "Validación",
                    MessageBoxButton.OK,
                    MessageBoxImage.Warning);
            ...
            if (!string.IsNullOrWhiteSpace(telefono2Texto))
            {
                ...
                {
                    MessageBox.Show(
                        "El móvil 2 debe contener solo números.",
                        "Validación",
                        MessageBoxButton.OK,
                        MessageBoxImage.Warning);
                    return;
            ...
            var codigoPostal = CodigoPostalTextBox.Text.Trim();
